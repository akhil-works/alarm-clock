window.addEventListener("DOMContentLoaded", function () {
  ...
  var clearAlarmImage = document.getElementById("clear-alarm");
  var errorMessage= document.getElementById("error");
  var alarms = [];

  // Function to update the clock
  ringtone=new Audio("./assets/twirling-intime-lenovo-k8-note-alarm-tone-41440.mp3");
  ...
  setAlarmButton.addEventListener("click", function () {
    ...
    if (
      ...
      // return;
        errorMessage.textContent = "Invalid alarm time";
  ...
  // ----------------------------- clear alarm button---------------------------------
function cleared (){
  clearAlarmImage.classList.add("move");
  renderAlarms()
  ringtone.pause();
}
clearAlarmImage.addEventListener("click", function () {
  clearAlarmImage.classList.remove("move");
  setInterval(cleared,1000);
